...
public class Database {
    ...
    // Initialize database: create table and insert sample questions
    public static void startDatabase() {
        try (Connection conn = DriverManager.getConnection(DB_URL);
            ...
            System.err.println("domain.domain.Database error: " + e.getMessage());
        }
    }
    ...
    private static void insertSampleQuestions(Connection conn) throws SQLException {
        ...
        try (PreparedStatement pstmt = conn.prepareStatement(insertSQL)) {
            // domain.domain.Question 1: Variables + Datatypes
            ...
            // domain.domain.Question 2: Loops + Conditions
            ...
            // domain.domain.Question 3: Functions + Objects
            ...
            // domain.domain.Question 4: Arrays
            ...
            // domain.domain.Question 5: Filer + Composition
            ...
            // domain.domain.Question 6: array[] + ArrayList
            ...
            // domain.domain.Question 7: CLI, Java klassen, Scanner
            ...
            // domain.domain.Question 8: Nedarvning + Interfaces
            ...
            // domain.domain.Question 9: Datastrukturer
            ...
            // domain.domain.Question 10: Databaser
    ...
    public static Question getQuestionById(int id) {
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL);
            ...
            // If question found, create and return domain.domain.Question object
            if (rs.next()) {
                String[] options = {
